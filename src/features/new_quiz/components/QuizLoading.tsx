// src/features/quiz/components/QuizLoading.tsx

import { DotLottieReact } from "@lottiefiles/dotlottie-react";
import { motion } from "framer-motion";
import { Check } from "lucide-react";
import React, { useEffect, useState } from "react";
import { LOADING_MESSAGES } from "../data/phases";
...
export const QuizLoading: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="text-2xl font-bold text-foreground mb-4">Creating Your Personalized Plan</h2>
